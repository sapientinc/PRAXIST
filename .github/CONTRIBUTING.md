...
Do not include credentials, private task data, research-run artifacts, or
unrelated generated files in issues or pull requests.
...
- [`AGENTS.md`](https://github.com/sapientinc/PRAXIST/blob/main/AGENTS.md) for
  the machine-friendly repository contract;
- the [architecture guide](https://praxist.sapient.inc/en/docs/concepts/architecture.html)
  for the active architecture; and
- the [documentation map](https://praxist.sapient.inc/en/docs/)
  for the authoritative documentation structure.
...
it and agree that it is governed by the repository's
[`LICENSE.md`](https://github.com/sapientinc/PRAXIST/blob/main/LICENSE.md),
including the contribution terms in Section 1.6. Praxist is source-available
under a non-OSI Fair Source license; contributing does not change that license
classification.

Community conduct is defined in
[`CODE_OF_CONDUCT.md`](https://github.com/sapientinc/PRAXIST/blob/main/.github/CODE_OF_CONDUCT.md).
Report security vulnerabilities privately to praxist@sapient.inc.
